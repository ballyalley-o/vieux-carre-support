export const en = {
  ...
  error: {
    ...
    error_close_ticket         : 'Error occured while closing the ticket',
    ...
    unauthorized_user          : 'You are not authorized to close this ticket',
    unauthorized_ticket_create : `[UNAUTHORIZED]: Unauthorized ticket creation attempt`,
    unauthorized_ticket_close  : `[UNAUTHORIZED]: Unauthorized ticket close attempt`,
